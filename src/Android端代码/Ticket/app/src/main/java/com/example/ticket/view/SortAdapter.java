 ...
 * 数据的适配器类
 *
 * 用SectionIndexer接口，对分组进行控制
 * 1.getSectionForPosition(int position)，根据ListView的position来找出当前位置所在的分组
 * 2.getPositionForSection(int section)，根据首字母的Char值
 *   来获取在该ListView中第一次出现该首字母的位置，即当前分组所在的位置
 */
...
public class SortAdapter extends BaseAdapter implements SectionIndexer{
    ...
    /**
     * 当ListView数据发生变化是，调用此方法来更新ListView
     * @param list
     */
    public void upddateListView(List<CitySortModel> list){
        this.list = list;
