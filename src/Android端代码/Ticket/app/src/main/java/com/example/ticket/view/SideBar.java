 ...
 * ListView右侧的字母索引View
 *
 * 用setTextView(TextView mTextDialog)来设置用来
 * 显示当前按下的字母的TextView；
 * 使用setOnTouchingLetterChangedListener方法来设置回调接口
 */
...
public class SideBar extends View{
    ...
    protected void onDraw(Canvas canvas){
        super.onDraw(canvas);
        int height = getHeight();//获取相对高度
        int width = getWidth();//获取相对宽度
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        switch (action){
            case MotionEvent.ACTION_UP:
                ...
                break;
            default:
                //和drawable.sidebar_background.xml关联
